package com.example.sql.activities;
...
import com.example.sql.bean.Note;
import com.example.sql.database.MyDatabaseOpenHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId() == MENU_ITEM_VIEW){
            ...
            // Start EditNoteActivity with feedback
    ...
    // if u start it using startActivityForResult()
    @Override
